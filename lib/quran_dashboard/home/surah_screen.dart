    ...
    if (available) {
      ...
      _speech.listen(
        onResult: (result) {
          ...
          searchSurah(result.recognizedWords);
        },
      );
    }
  }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // Bounded Stack so it can't silently overlap the list below it
              SizedBox(
                height: 32.h, // adjust to match your visual header height
                child: Stack(
                  children: [
                    Padding(
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 1.w, right: 1.w, top: 14.h),
                    ...
                    Padding(
                      padding:
                          EdgeInsets.only(left: 1.w, right: 1.w, top: 25.h),
                      child: Center(
